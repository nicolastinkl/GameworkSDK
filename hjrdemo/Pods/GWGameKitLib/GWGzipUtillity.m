...
+ (NSData *)gzipData:(NSData *)pUncompressedData
{
	...
	zlibStreamStruct.avail_in = (int)[pUncompressedData length];
	...
	do {
		...
		zlibStreamStruct.avail_out = (int)([compressedData length] - zlibStreamStruct.total_out);
