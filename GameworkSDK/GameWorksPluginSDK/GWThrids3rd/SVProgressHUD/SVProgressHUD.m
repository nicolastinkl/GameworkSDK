...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        ...
        if ([[UIImage class] instancesRespondToSelector:@selector(imageWithRenderingMode:)]) {
            SVProgressHUDInfoImage = [[self getImageWithFileName:@"info"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
            SVProgressHUDSuccessImage = [[self getImageWithFileName:@"success"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
            SVProgressHUDErrorImage = [[self getImageWithFileName:@"error"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
        } else {
            SVProgressHUDInfoImage = [self getImageWithFileName:@"info"];
            SVProgressHUDSuccessImage = [self getImageWithFileName:@"success"];
            SVProgressHUDErrorImage = [self getImageWithFileName:@"error"];
        }
...
-(UIImage *) getImageWithFileName:(NSString *) strName
{
    NSString *gwbundlePath = [[[[[NSBundle mainBundle].resourcePath
                                stringByAppendingPathComponent:@"Frameworks"]
                               stringByAppendingPathComponent:@"GameWorksSDK.framework"]
                                stringByAppendingPathComponent:@"GameWorksPluginSDK.framework"]
                                stringByAppendingPathComponent:@"SVProgressHUD.bundle"];
    
    NSBundle *bundle = [NSBundle bundleWithPath:gwbundlePath];
    
    NSString *img_path = [bundle pathForResource:strName ofType:@"png"];
