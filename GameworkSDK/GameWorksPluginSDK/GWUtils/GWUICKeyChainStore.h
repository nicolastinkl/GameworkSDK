...
extern NSString * const GWUICKeyChainStoreErrorDomain;

typedef NS_ENUM(NSInteger, GWUICKeyChainStoreErrorCode) {
    GWUICKeyChainStoreErrorInvalidArguments = 1,
};

@interface GWUICKeyChainStore : NSObject
